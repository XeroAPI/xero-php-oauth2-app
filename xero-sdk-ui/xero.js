...
var endpoint = [
    ...
    {name: "BankTransactions",action:[{name: "Create"},{name: "CreateMulti"},{name: "Read"},{name: "Update"},{name: "Delete"}]},
    {name: "BankTransfers",action:[{name: "Create"},{name: "Read"}]},
    {name: "BrandingThemes",action:[{name: "Read"}]},
    {name: "Contacts",action:[{name: "Create"},{name: "CreateMulti"},{name: "Read"},{name: "Update"},{name: "Archive"}]},
    ...
    {name: "Invoices",action:[{name: "Create"},{name: "CreateMulti"},{name: "Read"},{name: "Update"},{name: "Delete"},{name: "Void"}]},
