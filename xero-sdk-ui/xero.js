...
var endpoint = [
    ...
    {name: "RepeatingInvoices",action:[{name: "Read"},{name: "Create"},{name: "Update"}]},
    {name: "RepeatingInvoiceHistory",action:[{name: "Read"},{name: "Create"}]},
    ...
    {name: "Project",action:[{name: "Create"},{name: "Read"},{name: "Update"},{name: "Patch"}]},
    {name: "Projects",action:[{name: "Read"}]},
    {name: "Tasks",action:[{name: "Read"},{name: "Create"},{name: "Update"},{name: "Delete"}]},
    {name: "TimeEntries",action:[{name: "Read"}]},
    {name: "TimeEntry",action:[{name: "Read"},{name: "Create"},{name: "Update"},{name: "Delete"}]},
